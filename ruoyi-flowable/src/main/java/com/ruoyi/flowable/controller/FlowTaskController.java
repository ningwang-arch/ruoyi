...
public class FlowTaskController {
    ...
    @ApiOperation(value = "我发起的流程", response = BizFlowTaskDto.class)
    @GetMapping(value = "/myProcess")
    public AjaxResult myProcess(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum,
                                @ApiParam(value = "每页条数", required = true) @RequestParam Integer pageSize) {
        return flowTaskService.bizMyProcess(pageNum, pageSize);
    }
    ...
    public AjaxResult todoList(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum,
                               @ApiParam(value = "每页条数", required = true) @RequestParam Integer pageSize) {
        return flowTaskService.bizTodoList(pageNum, pageSize);
    }
    ...
    public AjaxResult finishedList(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum,
                                   @ApiParam(value = "每页条数", required = true) @RequestParam Integer pageSize) {
        return flowTaskService.bizFinishedList(pageNum, pageSize);
    ...
    public AjaxResult complete(@RequestBody BizFlowTaskVo flowTaskVo) {
        return flowTaskService.complete(flowTaskVo);
    }

    @ApiOperation(value = "驳回任务")
    @PostMapping(value = "/reject")
    public AjaxResult taskReject(@RequestBody BizFlowTaskVo flowTaskVo) {
    ...
    public AjaxResult taskReturn(@RequestBody BizFlowTaskVo flowTaskVo) {

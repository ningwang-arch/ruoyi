...
public interface IFlowTaskService {
     ...
     * @param task 请求实体参数
     */
    AjaxResult complete(BizFlowTaskVo task);
     ...
     * @param flowTaskVo
     */
    void taskReject(BizFlowTaskVo flowTaskVo);
     ...
     */
    void taskReturn(BizFlowTaskVo flowTaskVo);
    ...
    AjaxResult bizMyProcess(Integer pageNum, Integer pageSize);
    ...
    AjaxResult bizTodoList(Integer pageNum, Integer pageSize);

    AjaxResult bizFinishedList(Integer pageNum, Integer pageSize);
}
